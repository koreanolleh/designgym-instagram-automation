...
| 댓글 | 허용 |
| AI 생성 콘텐츠 표시 (is_aigc) | **false — 표시 안 함** (2026-07-30 변경). 이미지는 AI 생성물이며, 틱톡의 AI 콘텐츠 표시 규정 요구사항·자체 탐지·노출 제한 가능성에 대한 안내를 받은 뒤 계정 소유자가 전부 미표시를 선택함. 사람 포함 컷만 표시하는 중간안도 제시받았으나 전체 미표시를 택함 |
